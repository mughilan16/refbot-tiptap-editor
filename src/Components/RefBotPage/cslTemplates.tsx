...
export const cslTemplated: { csl: string, name: string, key: string }[] = [
  ...
  {
    name: 'Harvard Elsevier',
    key: 'harvard_elsevier',
    csl: `<?xml version="1.0" encoding="utf-8"?>
  ...
  {
    "name": "chicago-annotated-bibliography.csl",
    "csl": `<?xml version="1.0" encoding="utf-8"?>
    <style xmlns="http://purl.org/net/xbiblio/csl" class="note" version="1.0" demote-non-dropping-particle="display-and-sort" page-range-format="chicago">
      <info>
    ...
    `,
    "key": "chicago-annotated-bibliography.csl"
  },
  {
    "name": "chicago-author-date-16th-edition.csl",
    "csl": `<?xml version="1.0" encoding="utf-8"?>
    <style xmlns="http://purl.org/net/xbiblio/csl" class="in-text" version="1.0" demote-non-dropping-particle="display-and-sort" page-range-format="chicago">
      <info>
        <title>Chicago Manual of Style 16th edition (author-date)</title>
    ...
    `,
    "key": "chicago-author-date-16th-edition.csl"
  },
  {
    "name": "chicago-author-date-de.csl",
    "csl": `<?xml version="1.0" encoding="utf-8"?>
    ...
    `,
    "key": "chicago-author-date-de.csl"
  },
  {
    "name": "chicago-author-date-fr.csl",
    "csl": `<?xml version="1.0" encoding="utf-8"?>
    <style xmlns="http://purl.org/net/xbiblio/csl" class="in-text" version="1.0" demote-non-dropping-particle="display-and-sort" page-range-format="chicago" default-locale="fr-FR">
      <info>
        <title>Chicago Manual of Style 17th edition (author-date, Français)</title>
        ...
        <author>
          <name>Anne Le-Huu Pineault</name>
          <email>anne-gabrielle.le-huu.pineault@umontreal.ca</email>
        </author>
        <category citation-format="author-date"/>
        <category field="generic-base"/>
        ...
        <group delimiter=". ">
          ...
          <choose>
            ...
            <else-if type="entry-encyclopedia" variable="DOI" match="all">
              <date variable="issued" form="text" prefix="Consulté le "/>
            </else-if>
            ...
            <choose>
              <if variable="reviewed-title">
                <group delimiter=". ">
                  ...
                  <group delimiter=", ">
                    <text variable="reviewed-title" text-case="capitalize-first" font-style="italic" prefix="Review of "/>
                    <names variable="reviewed-author">
                      <label form="verb-short" text-case="lowercase" suffix=" "/>
                      <name and="text" delimiter=", "/>
                      <et-al/>
      ...
      <macro name="container-title">
        ...
        <choose>
          ...
          <else-if type="legal_case chapter paper-conference entry-dictionary" match="none">
            <group delimiter=" ">
    ...
    `,
    "key": "chicago-author-date-fr.csl"
  },
  {
    "name": "chicago-author-date-no-em-dash.csl",
    "csl": `<?xml version="1.0" encoding="utf-8"?>
    <style xmlns="http://purl.org/net/xbiblio/csl" class="in-text" version="1.0" demote-non-dropping-particle="display-and-sort" page-range-format="chicago">
      <info>
        <title>Chicago Manual of Style 17th edition (author-date, no em-dash in bibliography)</title>
        <id>http://www.zotero.org/styles/chicago-author-date-no-em-dash</id>
        <link href="http://www.zotero.org/styles/chicago-author-date-no-em-dash" rel="self"/>
        <link href="http://www.chicagomanualofstyle.org/tools_citationguide.html" rel="documentation"/>
        <author>
          <name>Julian Onions</name>
          <email>julian.onions@gmail.com</email>
    ...
    `,
    "key": "chicago-author-date-no-em-dash.csl"
  },
  {
    "name": "chicago-author-date.csl",
    "csl": `<?xml version="1.0" encoding="utf-8"?>
    <style xmlns="http://purl.org/net/xbiblio/csl" class="in-text" version="1.0" demote-non-dropping-particle="display-and-sort" page-range-format="chicago">
      <info>
    ...
    `,
    "key": "chicago-author-date.csl"
  },
  {
    "name": "chicago-figures.csl",
    "csl": `<?xml version="1.0" encoding="utf-8"?>
    ...
    `,
    "key": "chicago-figures.csl"
  },
  {
    "name": "chicago-fullnote-bibliography-16th-edition.csl",
    "csl": `<?xml version="1.0" encoding="utf-8"?>
    <style xmlns="http://purl.org/net/xbiblio/csl" class="note" version="1.0" demote-non-dropping-particle="display-and-sort" page-range-format="chicago">
      <info>
        <title>Chicago Manual of Style 16th edition (full note)</title>
    ...
    `,
    "key": "chicago-fullnote-bibliography-16th-edition.csl"
  },
  {
    "name": "chicago-fullnote-bibliography-fr.csl",
    "csl": `<?xml version="1.0" encoding="utf-8"?>
    <style xmlns="http://purl.org/net/xbiblio/csl" class="note" version="1.0" demote-non-dropping-particle="display-and-sort" page-range-format="chicago" default-locale="fr-FR">
      <info>
        <title>Chicago Manual of Style 17th edition (full note, Français)</title>
        <id>http://www.zotero.org/styles/chicago-fullnote-bibliography-fr</id>
        <link href="http://www.zotero.org/styles/chicago-fullnote-bibliography-fr" rel="self"/>
        <link href="http://guides.bib.umontreal.ca/disciplines/483-Citer-selon-le-style-Chicago?tab=2191" rel="documentation"/>
        <author>
          <name>Anne Le-Huu Pineault</name>
          <email>anne-gabrielle.le-huu.pineault@umontreal.ca</email>
        </author>
        <category citation-format="note"/>
        <category field="generic-base"/>
        <summary>Adaptation française du style "Chicago" (méthode note de bas de page), 17e édition</summary>
        <updated>2019-09-23T00:00:00+00:00</updated>
        <rights license="http://creativecommons.org/licenses/by-sa/3.0/">This work is licensed under a Creative Commons Attribution-ShareAlike 3.0 License</rights>
      </info>
      <locale xml:lang="fr">
                ...
                <group delimiter=", ">
                  <group delimiter=" ">
                    <group delimiter=", ">
                      <text variable="title" font-style="italic"/>
                      <text variable="medium"/>
                      <text macro="contributors-note" prefix="réalisé par "/>
                      <group prefix="(" suffix=")" delimiter=", ">
                        <text macro="publisher"/>
                        <text macro="issued"/>
                      </group>
    ...
    `,
    "key": "chicago-fullnote-bibliography-fr.csl"
  },
  {
    "name": "chicago-fullnote-bibliography-no-em-dash.csl",
    "csl": `<?xml version="1.0" encoding="utf-8"?>
    <style xmlns="http://purl.org/net/xbiblio/csl" class="note" version="1.0" demote-non-dropping-particle="display-and-sort" page-range-format="chicago">
      <info>
        <title>Chicago Manual of Style 17th edition (full note, no em-dash in bibliography)</title>
        <id>http://www.zotero.org/styles/chicago-fullnote-bibliography-no-em-dash</id>
        <link href="http://www.zotero.org/styles/chicago-fullnote-bibliography-no-em-dash" rel="self"/>
        <link href="http://www.chicagomanualofstyle.org/tools_citationguide.html" rel="documentation"/>
        <author>
          <name>Julian Onions</name>
          <email>julian.onions@gmail.com</email>
    ...
    `,
    "key": "chicago-fullnote-bibliography-no-em-dash.csl"
  },
  {
    "name": "chicago-fullnote-bibliography-short-title-subsequent.csl",
    "csl": `<?xml version="1.0" encoding="utf-8"?>
    <style xmlns="http://purl.org/net/xbiblio/csl" class="note" version="1.0" demote-non-dropping-particle="display-and-sort" page-range-format="chicago">
      <info>
    ...
    `,
    "key": "chicago-fullnote-bibliography-short-title-subsequent.csl"
  },
  {
    "name": "chicago-fullnote-bibliography-with-ibid.csl",
    "csl": `<?xml version="1.0" encoding="utf-8"?>
    <style xmlns="http://purl.org/net/xbiblio/csl" class="note" version="1.0" demote-non-dropping-particle="display-and-sort" page-range-format="chicago">
      <info>
        <title>Chicago Manual of Style 17th edition (full note, with Ibid.)</title>
    ...
    `,
    "key": "chicago-fullnote-bibliography-with-ibid.csl"
  },
  {
    "name": "chicago-fullnote-bibliography.csl",
    "csl": `<?xml version="1.0" encoding="utf-8"?>
    <style xmlns="http://purl.org/net/xbiblio/csl" class="note" version="1.0" demote-non-dropping-particle="display-and-sort" page-range-format="chicago">
      <info>
    ...
    `,
    "key": "chicago-fullnote-bibliography.csl"
  },
  {
    "name": "chicago-library-list.csl",
    "csl": `<?xml version="1.0" encoding="utf-8"?>
    <style xmlns="http://purl.org/net/xbiblio/csl" class="note" version="1.0" demote-non-dropping-particle="display-and-sort" page-range-format="chicago">
      <info>
        <title>Chicago Manual of Style 17th edition (library list)</title>
    ...
    `,
    "key": "chicago-library-list.csl"
  },
  {
    "name": "chicago-note-bibliography-16th-edition.csl",
    "csl": `<?xml version="1.0" encoding="utf-8"?>
    <style xmlns="http://purl.org/net/xbiblio/csl" class="note" version="1.0" demote-non-dropping-particle="display-and-sort" page-range-format="chicago">
      <info>
    ...
    `,
    "key": "chicago-note-bibliography-16th-edition.csl"
  },
  {
    "name": "chicago-note-bibliography-with-ibid.csl",
    "csl": `<?xml version="1.0" encoding="utf-8"?>
    <style xmlns="http://purl.org/net/xbiblio/csl" class="note" version="1.0" demote-non-dropping-particle="display-and-sort" page-range-format="chicago">
      <info>
        <title>Chicago Manual of Style 17th edition (note, with Ibid.)</title>
    ...
    `,
    "key": "chicago-note-bibliography-with-ibid.csl"
  },
  {
    "name": "chicago-note-bibliography.csl",
    "csl": `<?xml version="1.0" encoding="utf-8"?>
    <style xmlns="http://purl.org/net/xbiblio/csl" class="note" version="1.0" demote-non-dropping-particle="display-and-sort" page-range-format="chicago">
      <info>
    ...
    `,
    "key": "chicago-note-bibliography.csl"
  }
] as const
